...
{
    public partial class Form_PersonelIslem : Form
    {
        public Form_PersonelIslem()
        {
            InitializeComponent();
        }
        ...
        private void Form_PersonelIslem_Load(object sender, EventArgs e)
        {
            Listele();
        }
        ...
        private void dg_veriler_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                Form_Personel form = new Form_Personel(Id);
                form.ShowDialog();
            }
            catch { }
        }
        ...
        {
            Form_Personel form = new Form_Personel();
            form.ShowDialog();
        }
