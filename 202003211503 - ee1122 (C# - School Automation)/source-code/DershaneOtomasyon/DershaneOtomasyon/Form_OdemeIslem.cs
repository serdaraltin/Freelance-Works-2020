...
{
    public partial class Form_OdemeIslem : Form
    {
        public Form_OdemeIslem()
        {
            InitializeComponent();
        }
        ...
        private void Form_OdemeIslem_Load(object sender, EventArgs e)
        {
            Listele();
        }
        ...
        private void dg_veriler_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                Form_Odeme form = new Form_Odeme(Id);
                form.ShowDialog();
            }
            catch { }
        }
        ...
        private void btn_Ekle_Click(object sender, EventArgs e)
        {
            ...
            Form_Odeme form = new Form_Odeme();
            form.ShowDialog();
        }
