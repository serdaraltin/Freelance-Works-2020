...
{
    public partial class Form_SinifIslem : Form
    {
        public Form_SinifIslem()
        {
            InitializeComponent();
        }
        ...
        private void Form_SinifIslem_Load(object sender, EventArgs e)
        {
            Listele();
        }
        ...
        private void dg_veriler_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                Form_Sinif form = new Form_Sinif(Id);
                form.ShowDialog();
            }
            catch { }
        }
        ...
        private void btn_Ekle_Click(object sender, EventArgs e)
        {
            ...
            Form_Sinif form = new Form_Sinif();
            form.ShowDialog();
        }
