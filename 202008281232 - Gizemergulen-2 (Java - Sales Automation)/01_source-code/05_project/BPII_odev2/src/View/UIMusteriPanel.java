...
public class UIMusteriPanel extends javax.swing.JFrame {
    ...
    private void Listele() {
        try {
            veritabani.Musteriler(tbVeriler);
        } catch (Exception hata) {
           
        }
    }

    public UIMusteriPanel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tbVeriler.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Tc", "Ad", "Soyad", "Telefon", "Adres", "Email", "Sosyal M.", "Posta"
            }
        ));
    ...
    private void btnGuncelleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuncelleActionPerformed
        new UIMusteri(id).setVisible(true);
        Listele();
    ...
    private void btnSilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSilActionPerformed
        try {
            ...
            veritabani.Sorgu("Delete From tbl_musteri Where id=" + id);
            Listele();
        } catch (Exception hata) {
    ...
    private void btnAraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAraActionPerformed
        if (txtAra.getText().equals("")) {
         ...
         try {
            veritabani.Musteriler(tbVeriler, txtAra.getText());
        } catch (Exception hata) {
