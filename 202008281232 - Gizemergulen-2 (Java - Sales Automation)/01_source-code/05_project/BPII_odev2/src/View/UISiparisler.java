...
public class UISiparisler extends javax.swing.JFrame {
    ...
    public UISiparisler() {
        ...
        try {
            ...
            Logger.getLogger(UISiparisler.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void btnGuncelleActionPerformed(java.awt.event.ActionEvent evt) throws SQLException {
        UISiparis arSiparis = new UISiparis(id);
    }
