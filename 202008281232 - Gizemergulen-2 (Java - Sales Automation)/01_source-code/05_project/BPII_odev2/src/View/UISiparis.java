...
public class UISiparis extends javax.swing.JFrame {
    ...
    public UISiparis() {
        ...
        try {
            ...
            Logger.getLogger(UISiparis.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public UISiparis(int _id) throws SQLException {
        id = _id;
        initComponents();
        Listele();
        try {
