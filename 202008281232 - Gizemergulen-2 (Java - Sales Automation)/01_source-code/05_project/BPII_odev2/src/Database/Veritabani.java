...
public class Veritabani {
    ...
    public DefaultTableModel Siparisler(JTable tablo) throws SQLException {
        try {
    ...
    public DefaultTableModel Musteriler(JTable tablo) throws SQLException {
        try {
            DefaultTableModel model = (DefaultTableModel) tablo.getModel();
            model.setRowCount(0);
            Connection conn = null;
    ...
    public DefaultTableModel Musteriler(JTable tablo, String ad) throws SQLException {
        try {
            DefaultTableModel model = (DefaultTableModel) tablo.getModel();
            model.setRowCount(0);
            Connection conn = null;
    ...
    public DefaultTableModel Siparisler(JTable tablo, int id) throws SQLException {
        try {
            DefaultTableModel model = (DefaultTableModel) tablo.getModel();
            model.setRowCount(0);
            Connection conn = null;
    ...
    public DefaultTableModel SiparislerMus(JTable tablo, int id) throws SQLException {
        try {
            DefaultTableModel model = (DefaultTableModel) tablo.getModel();
            model.setRowCount(0);
            Connection conn = null;
    ...
    public DefaultTableModel Urunler(JTable tablo) throws SQLException {
        try {
            DefaultTableModel model = (DefaultTableModel) tablo.getModel();
            model.setRowCount(0);
            Connection conn = null;
    ...
    public DefaultTableModel Urunler(JTable tablo, String ad) throws SQLException {
        try {
            DefaultTableModel model = (DefaultTableModel) tablo.getModel();
            model.setRowCount(0);
            Connection conn = null;
